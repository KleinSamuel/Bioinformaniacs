...
public class Example {
	public static void main(String[] args) {
		...
		cars.add(new Car(35, "VW GOLF R", new Vector<String>(
				Arrays.asList(new String[] { "Lenkrad", "Dach", "Sitze", "Reifen", "Licht", "ESP" }))));
		cars.add(new Car(60, "Porsche", new Vector<String>(
				Arrays.asList(new String[] { "Lenkrad", "Sitze", "Reifen", "Licht", "ABS", "ESP" }))));
		cars.add(new Car(50, "VW GOLF GTI", new Vector<String>(
				Arrays.asList(new String[] { "Lenkrad", "Dach", "Sitze", "Reifen", "Licht", "ABS", "ESP" }))));
		cars.add(new Car(70, "Corvette C7",
				new Vector<String>(Arrays.asList(new String[] { "Lenkrad", "Dach", "Sitze", "Reifen", "Licht", }))));
		cars.add(new Car(100, "Lamborghini", new Vector<String>(
				Arrays.asList(new String[] { "Lenkrad", "Dach", "Sitze", "Reifen", "Licht", "ABS" }))));
		// int cap = 10;
		// int start = 10;
		// int step = 10;
		Tree car_t;
		...
		car_t = new Tree(cars, Cluster_method.UPGMA);
		...
		// long dur = (int) ((end-s));
		// System.out.println("Execution for "+start+" Nodes took
		// "+((int)(dur/60000))+":"+(((int)(dur/1000))%60<10 ?
		// "0"+((int)(dur/1000))%60 : ((int)(dur/1000))%60)+":"+((dur%1000<100)
		// ? (dur%1000<10 ? "00" : "0") : "")+dur%1000+"min");
	...
	public static String generate_String(int length) {
		...
		for (int i = 0; i < length; i++)
			out += r.nextBoolean() ? abc.charAt(r.nextInt(length - 1))
					: abc.toLowerCase().charAt(r.nextInt(length - 1));
		return out;
	}
